...
export const mockUsers: DsiUser[] = [
  { userId: 'ADM-001', name: 'Admin CIE', email: 'admin@cie.ci', phone: '0700000010', role: 'CIE_ADMIN', status: 'ACTIVE', lastLogin: '2026-08-24T22:58:00Z', meterId: '', contractId: '', createdAt: '2026-01-10T08:00:00Z' },
  { userId: 'OPR-014', name: 'Koffi ASSI', email: 'k.assi@cie.ci', phone: '0700000011', role: 'CIE_OPERATOR', status: 'ACTIVE', lastLogin: '2026-08-24T17:20:00Z', meterId: '', contractId: '', createdAt: '2026-02-15T08:00:00Z' },
  { userId: 'DSI-002', name: 'Fatou DIALLO', email: 'f.diallo@cie.ci', phone: '0700000012', role: 'DSI_ADMIN', status: 'ACTIVE', lastLogin: '2026-08-24T09:02:00Z', meterId: '', contractId: '', createdAt: '2026-01-20T08:00:00Z' },
  { userId: 'CUST-001', name: 'Jean KOUADIO', email: 'jean.kouadio@email.com', phone: '0700000013', role: 'CLIENT', status: 'ACTIVE', lastLogin: '2026-08-24T23:05:00Z', meterId: 'MTR-458921', contractId: '1234567890', createdAt: '2026-08-24T20:00:00Z' },
  { userId: 'OPR-021', name: 'Awa CISSE', email: 'a.cisse@cie.ci', phone: '0700000014', role: 'CIE_OPERATOR', status: 'SUSPENDED', lastLogin: '2026-07-30T14:11:00Z', meterId: '', contractId: '', createdAt: '2026-03-01T08:00:00Z' },
]
